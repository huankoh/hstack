---
name: hstack-principle-boundary-discipline
description: Within an explicitly selected hstack workflow. Apply when wiring validation,
  error handling, or framework adapters. Concentrate guards at system boundaries (CLI,
  config, network, external APIs); trust internal types and keep business logic in
  pure functions.
