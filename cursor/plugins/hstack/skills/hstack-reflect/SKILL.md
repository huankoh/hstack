---
name: hstack-reflect
description: Within an explicitly selected hstack workflow. Spawn three parallel review
  subagents over the active transcript, surface learnings, and route each to a concrete
  edit on an existing skill. Use when the user says reflect.
...
- The user said "reflect" or "/hstack-reflect".
