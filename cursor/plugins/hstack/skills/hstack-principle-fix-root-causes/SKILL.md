---
name: hstack-principle-fix-root-causes
description: Within an explicitly selected hstack workflow. Apply when debugging.
  Trace each symptom to its root cause and fix it there; reproduce first, ask why
  until you reach it, resist nil-check guards that silence crashes.
