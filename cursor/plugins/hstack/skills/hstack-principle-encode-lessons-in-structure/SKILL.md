---
name: hstack-principle-encode-lessons-in-structure
description: Within an explicitly selected hstack workflow. Apply when you catch yourself
  writing the same instruction a second time, or notice a recurring correction. Encode
  the rule as a lint, metadata flag, runtime check, or script instead of more text.
