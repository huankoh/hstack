---
name: hstack-principle-model-the-domain
description: Within an explicitly selected hstack workflow. Apply when writing stateful
  logic, or when code branches a lot or repeats a shape assumption across files. Encode
  the domain in a structure instead of scattered conditionals.
