---
name: hstack-typescript-best-practices
description: Within an explicitly selected hstack workflow. TypeScript best practices.
  Use when reading or editing any .ts or .tsx file.
paths:
- '**/*.ts'
- '**/*.tsx'
