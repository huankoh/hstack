---
name: hstack-principle-laziness-protocol
description: Within an explicitly selected hstack workflow. Apply when refactoring,
  evaluating diff size, or tempted to add abstractions, layers, or signal threading.
