---
name: hstack-principle-subtract-before-you-add
description: Within an explicitly selected hstack workflow. Apply when sequencing
  an addition, refactor, or rewrite. Remove dead weight, redundant validators, and
  stub references first, then build on the simpler base.
