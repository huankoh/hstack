---
name: hstack-principle-experience-first
description: Within an explicitly selected hstack workflow. Apply when product, UX,
  or feature-scope tradeoffs come up. Choose user delight over implementation convenience;
  ship fewer polished features over more rough ones.
