---
name: hstack-principle-foundational-thinking
description: 'Within an explicitly selected hstack workflow. Apply before writing
  logic: choosing core types and data structures, sequencing scaffold-vs-feature work,
  asking what concurrent actors share. Get the data structures right so downstream
