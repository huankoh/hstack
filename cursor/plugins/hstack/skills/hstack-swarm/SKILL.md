---
name: hstack-swarm
description: Within an explicitly selected hstack workflow. Fan out N parallel workers,
  drain them, and return one report. Use for /hstack-swarm, 'swarm this', or parallel
  coverage, races, gauntlets, and exploration.
