...
The [first cloud task](https://example.invalid/private-codex-task-02)
...
A [fresh invocation-policy probe](https://example.invalid/private-codex-task-01)
...
A [committed-package cloud run](https://example.invalid/private-codex-task-03)
