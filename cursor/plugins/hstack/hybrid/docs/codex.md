...
The installed package was `0.14.8+hstack.f8db0a326ad7`, built from source `8b2ed0c623e30181dbdca56ca3d5f228fd3f2f51` with fingerprint `f8db0a326ad7844ef98ae236ddaaab99e7154975faf8d163fd6b3a67854c6145`. [CI passed for that source revision](https://example.invalid/private-ci-run-01).
